...
That target is the wealth-independent CARA (Merton) holding for an arithmetic
price with drift \(\alphabar\) and volatility \(\sigma\), and it is bounded for
an economic reason: the buy share \(\tfrac12(1+\tanh i)\) lies in \((0,1)\), so
